...
$data_info = select("select * from db_info");
?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Artikel Musholla Fathul Insani</h1>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  include "koneksi.php";
                  $no = 1;
                  $ambildata = mysqli_query($koneksi, "select * from db_info");
                  while ($tampil = mysqli_fetch_array($ambildata)){
                    ?>
                    <tr>
                      <td><?php echo $no++; ?></td>
                      <td><?php echo $tampil ['jdl_info']; ?></td>
                      <td><?php echo $tampil ['text_info']; ?></td>
                      <td><img src="thumbnail/<?php echo $tampil ['tmb_gmbr']; ?>" width="100"></td>
                      <td>
                        <a href="edit.php?id=<?php echo $tampil['id_info']; ?>" class="btn btn-secondary">Edit</a>
                        <a href="hapus.php?id=<?php echo $tampil['id_info']; ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                      <?php } ?>
                      </tr>
                ...
                <a href="tambahdatainfo.php"  class="btn btn-primary">Tambah Data</a></li>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
