...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Donasi Musholla Fathul Insani</h1>
          </div>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  include "koneksi.php";
                  $no = 1;
                  $ambildata = mysqli_query($koneksi, "select * from db_donasi");
                ...
                <a href="tambahdatadonasi.php"  class="btn btn-primary">Tambah Data</a></li>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            <div class="card">
              <div class="card-header">
                <h1 class="card-title">Bukti Donasi Masuk</h1>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                <thead>
                  ...
                  include "koneksi.php";
                  $no = 1;
                  $ambildata = mysqli_query($koneksi, "select * from db_bukti");
                  while ($tampil = mysqli_fetch_array($ambildata)){
                    echo "
                    <tr>
                    <td>$no</td>
                    <td>$tampil[nama]</td>
                    <td><img src='uploads/$tampil[bukti]' width='100'></td>
